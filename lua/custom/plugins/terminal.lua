...
vim.keymap.set('t', '<C-w>h', '<cmd>wincmd h<cr>', { desc = 'Go to left window' })
vim.keymap.set('t', '<C-w>j', '<cmd>wincmd j<cr>', { desc = 'Go to lower window' })
vim.keymap.set('t', '<C-w>k', '<cmd>wincmd k<cr>', { desc = 'Go to upper window' })
vim.keymap.set('t', '<C-w>l', '<cmd>wincmd l<cr>', { desc = 'Go to right window' })

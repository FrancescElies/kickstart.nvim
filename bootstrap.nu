match $nu.os-info.name { 
    ...
    _ => {
        ln -sf ("~/src/kickstart.nvim" | path expand --no-symlink) ("~/.config/nvim" | path expand --no-symlink)
        ln -sf ("~/src/kickstart.nvim/minimal-vimrc.vim" | path expand --no-symlink) ("~/.vimrc" | path expand --no-symlink)
    },
}

...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sd', find_files_buf_dir, { desc = 'Find Files buf [d]ir' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- stylua: ignore start
      ...
      vim.keymap.set({ 'x', 'o' }, 'af', function() TOS.select_textobject('@function.outer', 'textobjects') end)
      vim.keymap.set({ 'x', 'o' }, 'if', function() TOS.select_textobject('@function.inner', 'textobjects') end)
      vim.keymap.set({ 'x', 'o' }, 'ac', function() TOS.select_textobject('@class.outer', 'textobjects') end)
      vim.keymap.set({ 'x', 'o' }, 'ic', function() TOS.select_textobject('@class.inner', 'textobjects') end)
      vim.keymap.set({ 'x', 'o' }, 'as', function() TOS.select_textobject('@local.scope', 'locals') end)

      local TOW = require 'nvim-treesitter-textobjects.swap'
      vim.keymap.set('n', 'sn', function() TOW.swap_next '@parameter.inner' end) -- [s]wap with [n]ext parameter
      vim.keymap.set('n', 'sp', function() TOW.swap_next '@parameter.outer' end) -- [s]wap with [p]revious parameter

      local TOM = require 'nvim-treesitter-textobjects.move'
      vim.keymap.set({ 'n', 'x', 'o' }, ']m', function() TOM.goto_next_start('@function.outer', 'textobjects') end)
      vim.keymap.set({ 'n', 'x', 'o' }, ']]', function() TOM.goto_next_start('@class.outer', 'textobjects') end)
      -- You can also pass a list to group multiple queries.
      vim.keymap.set({ 'n', 'x', 'o' }, ']o', function() move.goto_next_start({ '@loop.inner', '@loop.outer' }, 'textobjects') end)
      -- You can also use captures from other query groups like `locals.scm` or `folds.scm`
      vim.keymap.set({ 'n', 'x', 'o' }, ']s', function() TOM.goto_next_start('@local.scope', 'locals') end)
      vim.keymap.set({ 'n', 'x', 'o' }, ']z', function() TOM.goto_next_start('@fold', 'folds') end)

      vim.keymap.set({ 'n', 'x', 'o' }, ']M', function() TOM.goto_next_end('@function.outer', 'textobjects') end)
      vim.keymap.set({ 'n', 'x', 'o' }, '][', function() TOM.goto_next_end('@class.outer', 'textobjects') end)

      vim.keymap.set({ 'n', 'x', 'o' }, '[m', function() TOM.goto_previous_start('@function.outer', 'textobjects') end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[[', function() TOM.goto_previous_start('@class.outer', 'textobjects') end)

      vim.keymap.set({ 'n', 'x', 'o' }, '[M', function() TOM.goto_previous_end('@function.outer', 'textobjects') end)
      vim.keymap.set({ 'n', 'x', 'o' }, '[]', function() TOM.goto_previous_end('@class.outer', 'textobjects') end)
      -- stylua: ignore end

      local TOR = require 'nvim-treesitter-textobjects.repeatable_move'

      -- Repeat movement with ; and ,
      -- vim way: ; goes to the direction you were moving.
      vim.keymap.set({ 'n', 'x', 'o' }, ';', TOR.repeat_last_move)
      vim.keymap.set({ 'n', 'x', 'o' }, ',', TOR.repeat_last_move_opposite)
